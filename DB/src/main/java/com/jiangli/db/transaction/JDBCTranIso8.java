...
public class JDBCTranIso8 {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            connection.setAutoCommit(false);//序列化隔离级别不提交时导致写阻塞
            //connection.setAutoCommit(true);
            connection.setTransactionIsolation(8);//可重复读
            ...
            connection2.setTransactionIsolation(8);//可重复读
