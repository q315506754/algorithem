 ...
 * @see java.net.URI
 */
public final class DubboURL implements Serializable {
    ...
    private volatile transient Map<String, DubboURL> urls;
    ...
    public DubboURL(String protocol, String host, int port) {
        this(protocol, null, null, host, port, null, (Map<String, String>) null);
    }

    public DubboURL(String protocol, String host, int port, String[] pairs) { // varargs ... confilict with the following path argument, use array instead.
        this(protocol, null, null, host, port, null, CollectionUtils.toStringMap(pairs));
    }

    public DubboURL(String protocol, String host, int port, Map<String, String> parameters) {
        this(protocol, null, null, host, port, null, parameters);
    }

    public DubboURL(String protocol, String host, int port, String path) {
        this(protocol, null, null, host, port, path, (Map<String, String>) null);
    }

    public DubboURL(String protocol, String host, int port, String path, String... pairs) {
        this(protocol, null, null, host, port, path, CollectionUtils.toStringMap(pairs));
    }

    public DubboURL(String protocol, String host, int port, String path, Map<String, String> parameters) {
        this(protocol, null, null, host, port, path, parameters);
    }

    public DubboURL(String protocol, String username, String password, String host, int port, String path) {
        this(protocol, username, password, host, port, path, (Map<String, String>) null);
    }

    public DubboURL(String protocol, String username, String password, String host, int port, String path, String... pairs) {
        this(protocol, username, password, host, port, path, CollectionUtils.toStringMap(pairs));
    }

    public DubboURL(String protocol, String username, String password, String host, int port, String path, Map<String, String> parameters) {
     ...
     * @see DubboURL
     */
    public static DubboURL valueOf(String url) {
        ...
        return new DubboURL(protocol, username, password, host, port, path, parameters);
    }
    ...
    public DubboURL setProtocol(String protocol) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public DubboURL setUsername(String username) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public DubboURL setPassword(String password) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public DubboURL setHost(String host) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public DubboURL setPort(int port) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public DubboURL setAddress(String address) {
    ...
    public List<DubboURL> getBackupUrls() {
        List<DubboURL> urls = new ArrayList<DubboURL>();
        urls.add(this);
        String[] backups = getParameter(Constants.BACKUP_KEY, new String[0]);
        if (backups != null && backups.length > 0) {
            for (String backup : backups) {
    ...
    public DubboURL setPath(String path) {
        return new DubboURL(protocol, username, password, host, port, path, getParameters());
    }
    ...
    private Map<String, DubboURL> getUrls() {
        if (urls == null) { // concurrent initialization is tolerant
            urls = new ConcurrentHashMap<String, DubboURL>();
        }
        return urls;
    }

    public DubboURL getUrlParameter(String key) {
        DubboURL u = getUrls().get(key);
        if (u != null) {
            return u;
        }
    ...
    public String getMethodParameterAndDecoded(String method, String key) {
        return DubboURL.decode(getMethodParameter(method, key));
    }

    public String getMethodParameterAndDecoded(String method, String key, String defaultValue) {
        return DubboURL.decode(getMethodParameter(method, key, defaultValue));
    }
    ...
    public DubboURL addParameterAndEncoded(String key, String value) {
        if (value == null || value.length() == 0) {
            return this;
        }
    ...
    public DubboURL addParameter(String key, boolean value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, char value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, byte value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, short value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, int value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, long value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, float value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, double value) {
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, Enum<?> value) {
        if (value == null) return this;
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, Number value) {
        if (value == null) return this;
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, CharSequence value) {
        if (value == null || value.length() == 0) return this;
        return addParameter(key, String.valueOf(value));
    }

    public DubboURL addParameter(String key, String value) {
        ...
        map.put(key, value);
        return new DubboURL(protocol, username, password, host, port, path, map);
    }

    public DubboURL addParameterIfAbsent(String key, String value) {
        if (key == null || key.length() == 0
                || value == null || value.length() == 0) {
            return this;
        }
     ...
     * @return A new URL
     */
    public DubboURL addParameters(Map<String, String> parameters) {
    ...
    public DubboURL addParametersIfAbsent(Map<String, String> parameters) {
        if (parameters == null || parameters.size() == 0) {
            return this;
        }
    ...
    public DubboURL addParameters(String... pairs) {
    ...
    public DubboURL addParameterString(String query) {
    ...
    public DubboURL removeParameter(String key) {
        if (key == null || key.length() == 0) {
            return this;
        }
    ...
    public DubboURL removeParameters(Collection<String> keys) {
    ...
    public DubboURL removeParameters(String... keys) {
    ...
    public DubboURL clearParameters() {
        return new DubboURL(protocol, username, password, host, port, path, new HashMap<String, String>());
    }
    ...
    public DubboURL setServiceInterface(String service) {
