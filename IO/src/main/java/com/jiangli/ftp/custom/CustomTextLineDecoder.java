...
public class CustomTextLineDecoder implements ProtocolDecoder {
     ...
     */
    public CustomTextLineDecoder(String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public CustomTextLineDecoder(LineDelimiter delimiter) {
     ...
     */
    public CustomTextLineDecoder(Charset charset) {
     ...
     * @param delimiter The line delimiter to use
     */
    public CustomTextLineDecoder(Charset charset, String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public CustomTextLineDecoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
