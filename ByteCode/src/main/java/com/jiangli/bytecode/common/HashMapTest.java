...
public class HashMapTest {
    public static void main(String[] args) {
         ...
         *
         ...
         CHECKCAST java/lang/String checks whether an objectref is of a certain type, the class reference of which is in the constant pool at index (indexbyte1 << 8 + indexbyte2)
         ASTORE 2
         */
        Map<String,String> map = new HashMap<String,String>();
        map.put("ddd","xxx");
        String str = map.get("ddd");
    }
